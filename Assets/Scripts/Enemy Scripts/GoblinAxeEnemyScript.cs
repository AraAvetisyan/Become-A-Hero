...
public class GoblinAxeEnemyScript : MonoBehaviour
{
    private EnemyHelth _enemyHelth;
    [SerializeField] private Animator goblinAxeAnimator;
    ...
    void Start()
    {
        ...
        goblinAxeAnimator = GetComponent<Animator>();
    ...
    private void Attack()
    {
        ...
        if (toAttack)
        {
            if (isRecharged)
            {
                goblinAxeAnimator.SetTrigger("IsAttacking");
                isRecharged = false;
            ...
            if (!isRecharged)
            {
                goblinAxeAnimator.SetFloat("Speed", 0f);
            }
        }
    }
    private void Flip()
    ...
    private void Idle()
    {
        goblinAxeAnimator.SetFloat("Speed", 0);
        moveSpeed = 0;
    ...
    private void ChasePlayer()
    {
        ...
        stopChase = 1;
        moveSpeed = 3;
        goblinAxeAnimator.SetFloat("Speed", 1);
        wait = false;
    ...
    public void Die()
    {
        ...
        {
            moveSpeed = 0;
            goblinAxeAnimator.SetBool("IsDead", true);
        }
    }
    public void Destroy()
    {
