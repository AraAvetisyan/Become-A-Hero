...
public class BoarEnemyScript : MonoBehaviour
{
    ...
    private void Attack()
    {
        ...
        if (toAttack)
        {
            ...
            if (!isRecharged)
            {
                boarAnimator.SetFloat("Speed", 0f);
            }
        }
    }
    private void Flip()
    ...
    private void Patrol()
    {
        ...
        if (!wait)
        {
            boarAnimator.SetFloat("Speed", 1);
            boarAnimator.SetBool("IsRunning", false);
        }
    ...
    private void ChasePlayer()
    {
        ...
        moveSpeed = 3;
        boarAnimator.SetFloat("Speed", 1);
        boarAnimator.SetBool("IsRunning", true);
        wait = false;
    ...
    public void Die()
    {
        ...
        {
            moveSpeed = 0;
            boarAnimator.SetBool("IsDead", true);
        }
    }
    public void Destroy()
    {
